      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="relative w-full px-8 py-3 text-lg font-semibold text-white rounded-lg overflow-hidden group bg-linear-to-r from-indigo-500 to-purple-600 hover:from-purple-600 hover:to-indigo-500 transition-all duration-500">
